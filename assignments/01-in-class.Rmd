---
title: "Bio 723, Lecture 01: In-class Assignment"
...
# 2. Character data 
  ...
  a. Evaluate the following code. Does it give the output you expect? Why or why not? [1 pt]
  ...
  a. `paste` and `str_c` both join strings, but given the same inputs they produce different outputs.  Modify the call to `str_c` below to make the outputs identical. [1 pt]
