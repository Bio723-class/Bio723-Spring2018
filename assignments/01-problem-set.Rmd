...
1. The columns of the form `Call.1.P..` represent quality control information. Use the `stringr::str_detect` function (and any other functions that are useful) to count how many such columns there are.
