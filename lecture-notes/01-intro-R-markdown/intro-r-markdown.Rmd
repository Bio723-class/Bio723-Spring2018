---
title: "Introduction to R Markdown and R Notebooks"
...
```{r, echo = FALSE, out.width = "600px", fig.align = "center", fig.cap = "Using the File menu to create a new R Notebook."}
knitr::include_graphics("fig-create-rnotebook.png")
```
...
```{r, echo = FALSE, out.width = "600px", fig.align = "center", fig.cap = "Click the Run button to execute a code chunk."}
knitr::include_graphics("fig-run-code-chunk.png")
```
...
```{r, echo = FALSE, out.width = "600px", fig.align = "center", fig.cap = "An R Notebook showing an embedded plot after executing a code chunk."}
knitr::include_graphics("fig-rstudio-after-run-chunk.png")
```
...
```{r, echo = FALSE, out.width = "600px", fig.align = "center", fig.cap = "Use the 'Run all chunks above' button to evaluate all previous code chunks."}
knitr::include_graphics("fig-code-chunk-runall.png")
```
...
```{r, echo = FALSE, out.width = "600px", fig.align = "center", fig.cap = "Use the 'Knit to HTML' menu to generate HTML output from your R Notebook"}
knitr::include_graphics("fig-rstudio-knit-to-html.png")
```
